...
// import './Analysis.css'; // Importing CSS file for styling
...
//              <div className="icon"><i className="fas fa-dollar-sign"></i></div> {/* Icon for revenue */}
...
//                <div className="icon"><i className="fas fa-ticket-alt"></i></div> {/* Icon for ticket */}
//                <div className='content'>
...
//                  <div className="icon"><i className="fas fa-chart-line"></i></div> {/* Icon for Feedback Analysis */}
